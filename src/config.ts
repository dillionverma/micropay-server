...
export interface Config {
  lndHost: string;
  lndMacaroonAdmin: string;
  lndMacaroonReadOnly: string;
  lndMacaroonInvoice: string;
  lndTlsCert: string;
  port: string | number;
  dalleApiKey: string;
  supabaseUrl: string;
  supabaseApiKey: string;
  telegramPrivateNotifierBotToken: string;
  telegramGenerationsBotToken: string;
  telegramGenerationsBotId: string;
  telegramUserIdDillion: string;
  telegramUserIdHaseab: string;
  sentryDsn: string;
  awsAccessKey: string;
  awsSecretKey: string;
  mockImages: string;
  githubCIToken: string;
  codecovToken: string;
}
...
export enum ENV_KEYS {
  ...
  TELEGRAM_GENERATIONS_BOT_ID = "telegramGenerationsBotId",
...
export const config: Config = {
  ...
  [ENV_KEYS.TELEGRAM_GENERATIONS_BOT_ID]:
    process.env.TELEGRAM_GENERATIONS_BOT_ID,
